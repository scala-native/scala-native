...
object Settings {
  ...
  lazy val thisBuildSettings = Def.settings(
    ...
    // CI: ActionCache races on *.sbtdir.zip / parallel unpack.
    Global / cacheStores := {
    ...
    // Windows CI: serialize Compile to reduce packageBin jar replace races.
      ...
      val nestedCiMitigations = Option.when(isCI) {
        ...
        IO.write(
          ...
          s"""|// Generated by scala-native Settings.sbtPluginSettings for CI scripted.
              ...
              |$windowsCompileLimit""".stripMargin
        )
