...
// JUnit modules ------------------------------------------------
  ...
  lazy val junitTestOutputsNative =
    MultiScalaProject("junitTestOutputsNative", file("junit-test"), platform = "output-native", platformToName = false)
  ...
  lazy val junitTestOutputsJVM =
    MultiScalaProject("junitTestOutputsJVM", file("junit-test"), platform = "output-jvm", platformToName = false)
      .settings(
