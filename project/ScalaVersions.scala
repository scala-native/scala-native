...
object ScalaVersions {
  ...
  lazy val scala3RCVersions = List("3.8.3-RC1")
  ...
  val scala3Nightly = "3.8.4-RC1-bin-20260223-dd3cd80-NIGHTLY"
  ...
  val sbt2Version: String = "2.0.0-RC9"
  val sbt2ScalaVersion: String = "3.8.1"
