...
## Deprecated definitions waiting for lock on this file.

**Move to "Deprecated definitions" section above after PR #3003 has been
merged or declined.**
...
* org.junit.Assert.assertEquals(expected: Double, actual: Double)

* org.junit.Assert.assertEquals(message: String, expected: Double,
	actual: Double)
...
* scala.scalanative.runtime.GC.alloc(rawty: RawPtr, size: CSize)

* scala.scalanative.runtime.GC.alloc_atomic(rawty: RawPtr, size: CSize)

* scala.scalanative.runtime.Platform.windowsGetUserCountry()

* scala.scalanative.runtime.Platform.windowsGetUserLang()

* scala.scalanative.runtime.package.toClass(rtti: RawPtr)

* scala.scalanative.runtime.package.toRawType(cls: Class[_])

* scala.scalanative.runtime.package.getRawType(obj: Object)
