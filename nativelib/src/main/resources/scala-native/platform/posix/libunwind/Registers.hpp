...
inline Registers_ppc::Registers_ppc(const void *registers) {
    ...
    memcpy(_vectorRegisters,
           static_cast<const uint8_t *>(registers) +
               sizeof(ppc_thread_state_t) + sizeof(ppc_float_state_t),
...
inline Registers_ppc64::Registers_ppc64(const void *registers) {
    ...
    static_assert(sizeof(_registers) + sizeof(_vectorScalarRegisters) == 1336,
...
inline bool Registers_arm64::validVectorRegister(int) const { return false; }
...
inline Registers_arm::Registers_arm(const void *registers)
    : _use_X_for_vfp_save(false), _saved_vfp_d0_d15(false),
...
inline bool Registers_arm::validVectorRegister(int) const { return false; }
...
inline void Registers_or1k::setVectorRegister(int /* regNum */,
                                              v128 /* value */) {
    _LIBUNWIND_ABORT("or1k vector support not implemented");
}
...
inline void Registers_mips_o32::setVectorRegister(int /* regNum */,
                                                  v128 /* value */) {
    _LIBUNWIND_ABORT("mips_o32 vector support not implemented");
}
...
inline void Registers_mips_newabi::setVectorRegister(int /* regNum */,
                                                     v128 /* value */) {
    _LIBUNWIND_ABORT("mips_newabi vector support not implemented");
}
...
inline void Registers_hexagon::setVectorRegister(int /* regNum */,
                                                 v128 /* value */) {
    _LIBUNWIND_ABORT("hexagon vector support not implemented");
}
...
inline bool Registers_riscv::validVectorRegister(int) const { return false; }
...
class _LIBUNWIND_HIDDEN Registers_ve {
  ...
  private:
    ...
    // SjLj exception support only, so Registers_ve is not implemented
    // completely.
