...
#define LINE_SIZE ((size_t)1UL << LINE_SIZE_BITS)
...
#define LARGE_BLOCK_SIZE ((size_t)1 << LARGE_BLOCK_SIZE_BITS)

#define LARGE_OBJECT_MIN_SIZE_BITS 13
#define LARGE_OBJECT_MAX_SIZE_BITS 34

#define MIN_BLOCK_SIZE ((size_t)1UL << LARGE_OBJECT_MIN_SIZE_BITS)
#define MAX_BLOCK_SIZE ((size_t)1UL << LARGE_OBJECT_MAX_SIZE_BITS)

#define LARGE_BLOCK_MASK (~(((size_t)1 << LARGE_OBJECT_MIN_SIZE_BITS) - 1))
