...
int scalanative_at_eaccess() { return AT_EACCESS; }
int scalanative_at_empty_path() { return AT_EMPTY_PATH; }
int scalanative_at_no_automount() { return AT_NO_AUTOMOUNT; }
int scalanative_at_removedir() { return AT_REMOVEDIR; }
int scalanative_at_symlink_follow() { return AT_SYMLINK_FOLLOW; }
int scalanative_at_symlink_nofollow() { return AT_SYMLINK_NOFOLLOW; }
