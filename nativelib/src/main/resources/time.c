...
static void scalanative_tm_init(struct scalanative_tm *scala_tm, struct tm *tm) {
...
struct scalanative_tm *scalanative_gmtime_r(const time_t *clock, struct scalanative_tm *result) {
  struct tm tm;
  gmtime_r(clock, &tm);
...
struct scalanative_tm *scalanative_localtime_r(const time_t *clock, struct scalanative_tm *result) {
  struct tm tm;
...
size_t scalanative_strftime(char *buf, size_t maxsize, const char *format, struct scalanative_tm *scala_tm) {
  struct tm tm;
  tm_init(&tm, scala_tm);
