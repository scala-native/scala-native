...
final class ULong private[scala] (private val underlying: Long) extends AnyVal
  ...
  @inline final def /(x: UInt): ULong = this / x.toULong
  /** Returns the quotient of this value and `x`. */
  @inline final def /(x: ULong): ULong = new ULong(JLong.divideUnsigned(underlying, x.underlying))
  ...
  @inline final def %(x: UInt): ULong = this % x.toULong
  /** Returns the remainder of the division of this value by `x`. */
  @inline final def %(x: ULong): ULong = new ULong(JLong.remainderUnsigned(underlying, x.underlying))

  @inline final override def toString(): String = JLong.toUnsignedString(underlying)
