...
class CAtomicUnsignedLong extends CAtomic {
  ...
  def fetchAdd(value: CUnsignedLong): CUnsignedLong =
    atomic_add_ulong(atm.cast[Ptr[CUnsignedLong]], value)
  ...
  def fetchSub(value: CUnsignedLong): CUnsignedLong =
    atomic_sub_ulong(atm.cast[Ptr[CUnsignedLong]], value)
  ...
  def fetchAnd(value: CUnsignedLong): CUnsignedLong =
    atomic_and_ulong(atm.cast[Ptr[CUnsignedLong]], value)
  ...
  def fetchOr(value: CUnsignedLong): CUnsignedLong =
    atomic_or_ulong(atm.cast[Ptr[CUnsignedLong]], value)
  ...
  def fetchXor(value: CUnsignedLong): CUnsignedLong =
    atomic_xor_ulong(atm.cast[Ptr[CUnsignedLong]], value)
