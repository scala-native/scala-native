...
class CAtomicChar extends CAtomic {
  ...
  def fetchAdd(value: CChar): CChar =
    atomic_add_char(atm.cast[Ptr[CChar]], value)
  ...
  def fetchSub(value: CChar): CChar =
    atomic_sub_char(atm.cast[Ptr[CChar]], value)
  ...
  def fetchAnd(value: CChar): CChar =
    atomic_and_char(atm.cast[Ptr[CChar]], value)
  ...
  def fetchOr(value: CChar): CChar =
    atomic_or_char(atm.cast[Ptr[CChar]], value)
  ...
  def fetchXor(value: CChar): CChar =
    atomic_xor_char(atm.cast[Ptr[CChar]], value)
