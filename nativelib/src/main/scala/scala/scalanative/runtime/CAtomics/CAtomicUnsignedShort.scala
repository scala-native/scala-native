...
class CAtomicUnsignedShort extends CAtomic {
  ...
  private[this] val atm = alloc(sizeof[CUnsignedShort])
    .cast[Ptr[CUnsignedShort]]
  ...
  def fetchAdd(value: CUnsignedShort): CUnsignedShort =
    atomic_add_ushort(atm.cast[Ptr[CUnsignedShort]], value)
  ...
  def fetchSub(value: CUnsignedShort): CUnsignedShort =
    atomic_sub_ushort(atm.cast[Ptr[CUnsignedShort]], value)
  ...
  def fetchAnd(value: CUnsignedShort): CUnsignedShort =
    atomic_and_ushort(atm.cast[Ptr[CUnsignedShort]], value)
  ...
  def fetchOr(value: CUnsignedShort): CUnsignedShort =
    atomic_or_ushort(atm.cast[Ptr[CUnsignedShort]], value)
  ...
  def fetchXor(value: CUnsignedShort): CUnsignedShort =
    atomic_xor_ushort(atm.cast[Ptr[CUnsignedShort]], value)
