...
object Boxes {
  ...
  @inline def boxToUWord(v: RawWord): UWord = new UWord(v)

  @inline def unboxToWord(o: java.lang.Object): RawWord =
    if (o == null) Intrinsics.castIntToRawWord(0)
    else o.asInstanceOf[Word].rawWord
  @inline def unboxToUWord(o: java.lang.Object): RawWord =
    if (o == null) Intrinsics.castIntToRawWord(0)
    else o.asInstanceOf[UWord].rawWord
...
// ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/runtime/Boxes.scala.gyb", line: 76)
  ...
  @inline def unboxToCFuncPtr11[T1,
                                T2,
                                T3,
                                T4,
                                T5,
...
// ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/runtime/Boxes.scala.gyb", line: 76)
  ...
  @inline def unboxToCFuncPtr12[T1,
                                T2,
                                T3,
                                T4,
                                T5,
    ...
    if (v == null) null
      ...
      CFuncPtr13
        .fromRawPtr[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, R](
          v)
  @inline def unboxToCFuncPtr13[T1,
                                T2,
                                T3,
                                T4,
                                T5,
  ...
  @inline def boxToCFuncPtr14[T1,
    ...
    if (v == null) null
      ...
      CFuncPtr14.fromRawPtr[T1,
                            ...
                            T14,
                            R](v)
  @inline def unboxToCFuncPtr14[T1,
                                T2,
                                T3,
                                T4,
                                T5,
  ...
  @inline def boxToCFuncPtr15[T1,
    ...
    if (v == null) null
      ...
      CFuncPtr15.fromRawPtr[T1,
                            ...
                            T15,
                            R](v)
  @inline def unboxToCFuncPtr15[T1,
                                T2,
                                T3,
                                T4,
                                T5,
  ...
  @inline def boxToCFuncPtr16[T1,
    ...
    if (v == null) null
      ...
      CFuncPtr16.fromRawPtr[T1,
                            ...
                            T16,
                            R](v)
  @inline def unboxToCFuncPtr16[T1,
                                T2,
                                T3,
                                T4,
                                T5,
  ...
  @inline def boxToCFuncPtr17[T1,
    ...
    if (v == null) null
      ...
      CFuncPtr17.fromRawPtr[T1,
                            ...
                            T17,
                            R](v)
  @inline def unboxToCFuncPtr17[T1,
                                T2,
                                T3,
                                T4,
                                T5,
  ...
  @inline def boxToCFuncPtr18[T1,
    ...
    if (v == null) null
      ...
      CFuncPtr18.fromRawPtr[T1,
                            ...
                            T18,
                            R](v)
  @inline def unboxToCFuncPtr18[T1,
                                T2,
                                T3,
                                T4,
                                T5,
  ...
  @inline def boxToCFuncPtr19[T1,
    ...
    if (v == null) null
      ...
      CFuncPtr19.fromRawPtr[T1,
                            ...
                            T19,
                            R](v)
  @inline def unboxToCFuncPtr19[T1,
                                T2,
                                T3,
                                T4,
                                T5,
  ...
  @inline def boxToCFuncPtr20[T1,
    ...
    if (v == null) null
      ...
      CFuncPtr20.fromRawPtr[T1,
                            ...
                            T20,
                            R](v)
  @inline def unboxToCFuncPtr20[T1,
                                T2,
                                T3,
                                T4,
                                T5,
  ...
  @inline def boxToCFuncPtr21[T1,
    ...
    if (v == null) null
      ...
      CFuncPtr21.fromRawPtr[T1,
                            ...
                            T21,
                            R](v)
  @inline def unboxToCFuncPtr21[T1,
                                T2,
                                T3,
                                T4,
                                T5,
  ...
  @inline def boxToCFuncPtr22[T1,
    ...
    if (v == null) null
      ...
      CFuncPtr22.fromRawPtr[T1,
                            ...
                            T22,
                            R](v)
  @inline def unboxToCFuncPtr22[T1,
                                T2,
                                T3,
                                T4,
                                T5,
