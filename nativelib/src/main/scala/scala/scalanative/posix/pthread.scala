...
import scala.scalanative.native.{CFunctionPtr0, CFunctionPtr1, CInt, CSize, CUnsignedInt, Ptr, extern, name}
...
object pthread {
  ...
  def pthread_attr_getdetachstate(attr: Ptr[pthread_attr_t], detachstate: Ptr[CInt]): CInt = extern

  def pthread_attr_getguardsize(attr: Ptr[pthread_attr_t], guardsize: Ptr[CSize]): CInt = extern

  def pthread_attr_getinheritsched(attr: Ptr[pthread_attr_t], inheritsched: Ptr[CInt]): CInt = extern

  def pthread_attr_getschedparam(attr: Ptr[pthread_attr_t], param: Ptr[sched_param]): CInt = extern

  def pthread_attr_getschedpolicy(attr: Ptr[pthread_attr_t], policy: Ptr[CInt]): CInt = extern

  def pthread_attr_getscope(attr: Ptr[pthread_attr_t], scope: Ptr[CInt]): CInt = extern

  def pthread_attr_getstack(attr: Ptr[pthread_attr_t], stackaddr: Ptr[Ptr[Byte]], stacksize: CSize): CInt = extern

  def pthread_attr_getstacksize(attr: Ptr[pthread_attr_t], stacksize: Ptr[CSize]): CInt = extern

  def pthread_attr_init(attr: Ptr[pthread_attr_t]): CInt = extern

  def pthread_attr_setdetachstate(attr: Ptr[pthread_attr_t], detachstate: CInt): CInt = extern

  def pthread_attr_setguardsize(attr: Ptr[pthread_attr_t], guardsize: CSize): CInt = extern

  def pthread_attr_setinheritsched(attr: Ptr[pthread_attr_t], inheritsched: CInt): CInt = extern

  def pthread_attr_setschedparam(attr: Ptr[pthread_attr_t], param: Ptr[sched_param]): CInt = extern

  def pthread_attr_setschedpolicy(attr: Ptr[pthread_attr_t], policy: CInt): CInt = extern

  def pthread_attr_setscope(attr: Ptr[pthread_attr_t], scope: CInt): CInt = extern

  def pthread_attr_setstack(attr: Ptr[pthread_attr_t], stackaddr: Ptr[Byte], stacksize: CSize): CInt = extern

  def pthread_attr_setstacksize(attr: Ptr[pthread_attr_t], stacksize: CSize): CInt = extern

  def pthread_barrier_destroy(barrier: Ptr[pthread_barrier_t]): CInt = extern

  def pthread_barrier_init(barrier: Ptr[pthread_barrier_t], attr: Ptr[pthread_barrierattr_t], count: CUnsignedInt): CInt = extern

  def pthread_barrier_wait(barrier: Ptr[pthread_barrier_t]): CInt = extern

  def pthread_barrierattr_destroy(attr: Ptr[pthread_barrierattr_t]): CInt = extern

  def pthread_barrierattr_getpshared(attr: Ptr[pthread_barrierattr_t], pshared: Ptr[CInt]): CInt = extern

  def pthread_barrierattr_init(attr: Ptr[pthread_barrierattr_t]): CInt = extern

  def pthread_barrierattr_setpshared(attr: Ptr[pthread_barrierattr_t], pshared: CInt): CInt = extern
  ...
  def pthread_cond_init(cond: Ptr[pthread_cond_t], attr: Ptr[pthread_condattr_t]): CInt = extern

  def pthread_cond_signal(cond: Ptr[pthread_cond_t]): CInt = extern

  def pthread_cond_timedwait(cond: Ptr[pthread_cond_t], mutex: Ptr[pthread_mutex_t], timespec: Ptr[timespec]): CInt = extern
  ...
  def pthread_condattr_getclock(attr: Ptr[pthread_condattr_t], clock: Ptr[clockid_t]): CInt = extern

  def pthread_condattr_getpshared(attr: Ptr[pthread_condattr_t], pshared: Ptr[CInt]): CInt = extern
  ...
  def pthread_create(thread: Ptr[pthread_t], attr: Ptr[pthread_attr_t],
    startroutine: CFunctionPtr1[Ptr[Byte], Ptr[Byte]], args: Ptr[Byte]): CInt = extern
  ...
  def pthread_getcpuclockid(thread: pthread_t, clock: Ptr[clockid_t]): CInt = extern

  def pthread_getschedparam(thread: pthread_t, policy: Ptr[CInt], param: Ptr[sched_param]): CInt = extern
  ...
  def pthread_key_create(key: Ptr[pthread_key_t], destructor: CFunctionPtr1[Ptr[Byte], Unit]): CInt = extern
  ...
  def pthread_mutex_getprioceiling(mutex: Ptr[pthread_mutex_t], prioceiling: Ptr[CInt]): CInt = extern

  def pthread_mutex_init(mutex: Ptr[pthread_mutex_t], attr: Ptr[pthread_mutexattr_t]): CInt = extern

  def pthread_mutex_lock(mutex: Ptr[pthread_mutex_t]): CInt = extern

  def pthread_mutex_setprioceiling(mutex: Ptr[pthread_mutex_t], prioceiling: CInt, old_prioceiling: Ptr[CInt]): CInt = extern

  def pthread_mutex_timedlock(mutex: Ptr[pthread_mutex_t], timespec: Ptr[timespec]): CInt = extern
  ...
  def pthread_mutexattr_getprioceiling(attr: Ptr[pthread_mutexattr_t], prioceiling: Ptr[CInt]): CInt = extern

  def pthread_mutexattr_getprotocol(attr: Ptr[pthread_mutexattr_t], protocol: Ptr[CInt]): CInt = extern

  def pthread_mutexattr_getpshared(attr: Ptr[pthread_mutexattr_t], pshared: Ptr[CInt]): CInt = extern

  def pthread_mutexattr_getrobust(attr: Ptr[pthread_mutexattr_t], robust: Ptr[CInt]): CInt = extern

  def pthread_mutexattr_gettype(attr: Ptr[pthread_mutexattr_t], tp: Ptr[CInt]): CInt = extern
  ...
  def pthread_mutexattr_setpshared(attr: Ptr[pthread_mutexattr_t], pshared: CInt): CInt = extern

  def pthread_mutexattr_setrobust(attr: Ptr[pthread_mutexattr_t], robust: CInt): CInt = extern

  def pthread_mutexattr_settype(attr: Ptr[pthread_mutexattr_t], tp: CInt): CInt = extern

  def pthread_once(once_control: Ptr[pthread_once_t], init_routine: CFunctionPtr0[Unit]): CInt = extern

  def pthread_rwlock_destroy(rwlock: Ptr[pthread_rwlock_t]): CInt = extern

  def pthread_rwlock_init(rwlock: Ptr[pthread_rwlock_t], attr: Ptr[pthread_rwlockattr_t]): CInt = extern

  def pthread_rwlock_rdlock(rwlock: Ptr[pthread_rwlock_t]): CInt = extern

  def pthread_rwlock_timedrdlock(rwlock: Ptr[pthread_rwlock_t], timespec: Ptr[timespec]): CInt = extern

  def pthread_rwlock_timedwrlock(rwlock: Ptr[pthread_rwlock_t], timespec: Ptr[timespec]): CInt = extern
  ...
  def pthread_rwlockattr_getpshared(
    attr: Ptr[pthread_rwlockattr_t], pshared: Ptr[CInt]): CInt = extern

  def pthread_rwlockattr_init(attr: Ptr[pthread_rwlockattr_t]): CInt = extern

  def pthread_rwlockattr_setpshared(attr: Ptr[pthread_rwlockattr_t], pshared: CInt): CInt = extern
  ...
  def pthread_setschedparam(thread: pthread_t, policy: CInt, param: Ptr[sched_param]): CInt = extern
  ...
  def pthread_spin_init(spinlock: Ptr[pthread_spinlock_t], pshared: CInt): CInt = extern
