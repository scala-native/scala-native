...
object CFuncPtr0 {
  ...
  def _fromScalaFunction(fn: Function0[_]): CFuncPtr0[_] = intrinsic
...
object CFuncPtr1 {
  ...
  def _fromScalaFunction(fn: Function1[_, _]): CFuncPtr1[_, _] = intrinsic
...
object CFuncPtr2 {
  ...
  def _fromScalaFunction(fn: Function2[_, _, _]): CFuncPtr2[_, _, _] = intrinsic
...
object CFuncPtr3 {
  ...
  def _fromScalaFunction(fn: Function3[_, _, _, _]): CFuncPtr3[_, _, _, _] = intrinsic
...
object CFuncPtr4 {
  ...
  def _fromScalaFunction(fn: Function4[_, _, _, _, _]): CFuncPtr4[_, _, _, _, _] = intrinsic
...
object CFuncPtr5 {
  ...
  def _fromScalaFunction(fn: Function5[_, _, _, _, _, _]): CFuncPtr5[_, _, _, _, _, _] = intrinsic
...
object CFuncPtr6 {
  ...
  def _fromScalaFunction(fn: Function6[_, _, _, _, _, _, _]): CFuncPtr6[_, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr7 {
  ...
  def _fromScalaFunction(fn: Function7[_, _, _, _, _, _, _, _]): CFuncPtr7[_, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr8 {
  ...
  def _fromScalaFunction(fn: Function8[_, _, _, _, _, _, _, _, _]): CFuncPtr8[_, _, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr9 {
  ...
  def _fromScalaFunction(fn: Function9[_, _, _, _, _, _, _, _, _, _]): CFuncPtr9[_, _, _, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr10 {
  ...
  def _fromScalaFunction(fn: Function10[_, _, _, _, _, _, _, _, _, _, _]): CFuncPtr10[_, _, _, _, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr11 {
  ...
  def _fromScalaFunction(fn: Function11[_, _, _, _, _, _, _, _, _, _, _, _]): CFuncPtr11[_, _, _, _, _, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr12 {
  ...
  def _fromScalaFunction(fn: Function12[_, _, _, _, _, _, _, _, _, _, _, _, _]): CFuncPtr12[_, _, _, _, _, _, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr13 {
  ...
  def _fromScalaFunction(fn: Function13[_, _, _, _, _, _, _, _, _, _, _, _, _, _]): CFuncPtr13[_, _, _, _, _, _, _, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr14 {
  ...
  def _fromScalaFunction(fn: Function14[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _]): CFuncPtr14[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr15 {
  ...
  def _fromScalaFunction(fn: Function15[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]): CFuncPtr15[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr16 {
  ...
  def _fromScalaFunction(fn: Function16[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]): CFuncPtr16[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr17 {
  ...
  def _fromScalaFunction(fn: Function17[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]): CFuncPtr17[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr18 {
  ...
  def _fromScalaFunction(fn: Function18[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]): CFuncPtr18[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr19 {
  ...
  def _fromScalaFunction(fn: Function19[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]): CFuncPtr19[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr20 {
  ...
  def _fromScalaFunction(fn: Function20[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]): CFuncPtr20[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr21 {
  ...
  def _fromScalaFunction(fn: Function21[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]): CFuncPtr21[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _] = intrinsic
...
object CFuncPtr22 {
  ...
  def _fromScalaFunction(fn: Function22[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]): CFuncPtr22[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _] = intrinsic
