...
final class Inet6Address private[net](ipAddress: Array[Byte], host: String, scopeId: Int) 
extends InetAddress(ipAddress, host) {

  private[net] def this(ipAddress: Array[Byte]) = this(ipAddress, null, 0)

  private[net] def this(ipAddress: Array[Byte], host: String) = this(ipAddress, host, 0)
