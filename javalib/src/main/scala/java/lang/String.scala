...
class _String private ()
    extends CharSequence
    with Serializable
    with Comparable[_String] {
  def this(value: Array[scala.Char], offset: scala.Int, count: scala.Int) =
    this()
  ...
  def getChars(srcBegin: scala.Int,
               srcEnd: scala.Int,
...
object _String {
  ...
  def valueOf(
      data: Array[Char], offset: scala.Int, count: scala.Int): _String = ???
