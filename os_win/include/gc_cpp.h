...
inline void operator delete[](void *obj) { GC_FREE(obj); }
#endif

inline void *operator new(size_t size) { return GC_MALLOC_UNCOLLECTABLE(size); }
...
inline void *operator new[](size_t size, int nBlockUse, const char *szFileName,
                            int nLine) {
...
inline void *gc::operator new(size_t size) { return GC_MALLOC(size); }
...
inline void *gc::operator new(size_t /* size */, void *p) { return p; }

inline void gc::operator delete(void *obj) { GC_FREE(obj); }

#ifdef GC_PLACEMENT_DELETE
inline void gc::operator delete(void *, void *) {}

inline void gc::operator delete(void *p, GCPlacement /* gcp */) { GC_FREE(p); }
#endif // GC_PLACEMENT_DELETE

#ifdef GC_OPERATOR_NEW_ARRAY
inline void *gc::operator new[](size_t size) { return gc::operator new(size); }
...
inline void gc::operator delete[](void *obj) { gc::operator delete(obj); }
...
inline gc_cleanup::gc_cleanup() {
    ...
    if (base != 0) {
        ...
        GC_register_finalizer_ignore_self(
            ...
            (void *)((char *)this_ptr - (char *)base), &oldProc, &oldData);
        if (oldProc != 0) {
