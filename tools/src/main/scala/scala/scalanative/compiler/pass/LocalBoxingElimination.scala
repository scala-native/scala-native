...
class LocalBoxingElimination extends Pass {
  ...
  override def preBlock = { case block =>
...
object LocalBoxingElimination {
  ...
  private final case class Box(code: Char, from: nir.Val, to: nir.Val) extends Record
  private final case class Unbox(code: Char, from: nir.Val, to: nir.Val) extends Record
