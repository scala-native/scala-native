...
class BigIntegerAndTest {
  ...
  @Test def testNegNegSameLength(): Unit = {
    ...
    val bSign = -1
    val rBytes =
      Array[Byte](-1, 1, 2, 3, 3, 0, 65, -96, -48, -124, -60, 12, -40, -31, 97)
    val aNumber = new BigInteger(aSign, aBytes)
    val bNumber = new BigInteger(bSign, bBytes)
    val result = aNumber.and(bNumber)
    var resBytes = Array.ofDim[Byte](rBytes.length)
  ...
  @Test def testNegPosSameLength(): Unit = {
    ...
    val bSign = 1
    val rBytes =
      Array[Byte](0, -2, 125, -60, -104, 1, 10, 6, 2, 32, 56, 2, 4, 4, 21)
    val aNumber = new BigInteger(aSign, aBytes)
    val bNumber = new BigInteger(bSign, bBytes)
    val result = aNumber.and(bNumber)
    var resBytes = Array.ofDim[Byte](rBytes.length)
  ...
  @Test def testPosPosFirstLonger(): Unit = {
    ...
    val bSign = 1
    val rBytes =
      Array[Byte](0, -2, -76, 88, 44, 1, 2, 17, 35, 16, 9, 2, 5, 6, 21)
    val aNumber = new BigInteger(aSign, aBytes)
    val bNumber = new BigInteger(bSign, bBytes)
    val result = aNumber.and(bNumber)
    var resBytes = Array.ofDim[Byte](rBytes.length)
  ...
  @Test def testPosPosSameLength(): Unit = {
    ...
    val bSign = 1
    val rBytes =
      Array[Byte](0, -128, 56, 100, 4, 4, 17, 37, 16, 1, 64, 1, 10, 3)
    val aNumber = new BigInteger(aSign, aBytes)
    val bNumber = new BigInteger(bSign, bBytes)
    val result = aNumber.and(bNumber)
    var resBytes = Array.ofDim[Byte](rBytes.length)
