...
class SynchronousQueueFairTest extends BlockingQueueTest {
  override protected def emptyCollection(): SynchronousQueue[Any] = new SynchronousQueue[Any](true)
}
class SynchronousQueueNonFairTest extends BlockingQueueTest {
  override protected def emptyCollection(): SynchronousQueue[Any] = new SynchronousQueue[Any](false)
}
