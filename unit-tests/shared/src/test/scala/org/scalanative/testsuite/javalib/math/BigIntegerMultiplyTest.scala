...
class BigIntegerMultiplyTest {
  ...
  @Test def testCase3(): Unit = {
    ...
    val aSign = 1
    val bSign = 1
    val rBytes = Array[Byte](10, 40, 100, -55, 96, 51, 76, 40, -45, 85, 115, 44,
      -127, 115, -21, -62, -15, 85, 64, -87, -2, -36, -36, -106)
    val aNumber = new BigInteger(aSign, aBytes)
    val bNumber = new BigInteger(bSign, bBytes)
    val result = aNumber.multiply(bNumber)
    var resBytes = Array.ofDim[Byte](rBytes.length)
  ...
  @Test def testPowNegativeNumToEvenExp(): Unit = {
    ...
    val rBytes = Array[Byte](102, 107, -122, -43, -52, -20, -27, 25, -9, 88,
      -13, 75, 78, 81, -33, -77, 39, 27, -37, 106, 121, -73, 108, -47, -101, 80,
      -25, 71, 13, 94, -7, -33, 1, -17, -65, -70, -61, -3, -47)
    val aNumber = new BigInteger(aSign, aBytes)
  ...
  @Test def testPowNegativeNumToOddExp(): Unit = {
    ...
    val aSign = -1
    val exp = 5
    val rBytes = Array[Byte](-21, -94, -42, -15, -127, 113, -50, -88, 115, -35,
      3, 59, -92, 111, -75, 103, -42, 41, 34, -114, 99, -32, 105, -59, 127, 45,
      108, 74, -93, 105, 33, 12, -5, -20, 17, -21, -119, -127, -115, 27, -122,
      26, -67, 109, -125, 16, 91, -70, 109)
    val aNumber = new BigInteger(aSign, aBytes)
    val result = aNumber.pow(exp)
    var resBytes = Array.ofDim[Byte](rBytes.length)
    resBytes = result.toByteArray()
  ...
  @Test def testPowPositiveNum(): Unit = {
    ...
    val rBytes = Array[Byte](20, 93, 41, 14, 126, -114, 49, 87, -116, 34, -4,
      -60, 91, -112, 74, -104, 41, -42, -35, 113, -100, 31, -106, 58, -128, -46,
      -109, -75, 92, -106, -34, -13, 4, 19, -18, 20, 118, 126, 114, -28, 121,
      -27, 66, -110, 124, -17, -92, 69, -109)
    val aNumber = new BigInteger(aSign, aBytes)
    val result = aNumber.pow(exp)
    var resBytes = Array.ofDim[Byte](rBytes.length)
    resBytes = result.toByteArray()
