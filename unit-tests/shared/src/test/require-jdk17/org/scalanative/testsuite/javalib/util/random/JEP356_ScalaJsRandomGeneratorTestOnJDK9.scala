// Ported from Scala.js commit: 9cb865f dated: 2025-03-16
...
class JEP356_ScalaJsRandomGeneratorTestOnJDK17 {
  ...
  @Test def testNextBytes(): Unit = {
    ...
    assertArrayEquals(
      Array[Byte](-57, 115, -16, -88, 107, 53, -1, -51, -45, -104, 79, -98, 43,
        -50, -45, 77),
      a16
    )
  ...
  @Test def testNextFloatWithBound(): Unit = {
    ...
    assertExactEquals(
      88902.516f,
      make(0xb85927b9d6e3249bL).nextFloat(123456.789f)
    )
    assertExactEquals(7.0590034f, make(0x0bf3df8c2f645e7dL).nextFloat(151.189f))
    assertExactEquals(
      0.0f,
      make(0x857f63be5f2f9ca0L).nextFloat(Float.MinPositiveValue)
    )
    assertExactEquals(
      2.1418906e38f,
      make(0xa12351957679f21fL).nextFloat(Float.MaxValue)
    )
    ...
    assertThrows(
      ...
      make().nextFloat(Float.MinValue)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextFloat(Float.PositiveInfinity)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextFloat(Float.NegativeInfinity)
    )
  ...
  @Test def testNextFloatWithOriginAndBound(): Unit = {
    assertExactEquals(
      0.9023377f,
      make(0xcdff356ba8f073c7L).nextFloat(0.5f, 1.0f)
    )
    assertExactEquals(
      -10.63579f,
      make(0x4dd3ce2b9e4f98d3L).nextFloat(-15.5f, 0.5f)
    )
    assertExactEquals(
      745774.4f,
      make(0xb85927b9d6e3249bL).nextFloat(123456.789f, 987654.321f)
    )
    assertExactEquals(
      -561941.4f,
      make(0x0bf3df8c2f645e7dL).nextFloat(-589456.0f, -151.189f)
    )
    assertExactEquals(
      123.456f,
      make(0x857f63be5f2f9ca0L).nextFloat(123.456f, 123.45601f)
    ) // 1 ulp of difference
    ...
    if (!executingInJVMOnLowerThanJDK(19)) {
      ...
      assertExactEquals(
        -5.4696933e37f,
        make(0xa12351957679f21fL).nextFloat(MinValue, MaxValue / 3.0f)
      )
      assertExactEquals(
        8.809577e37f,
        make(0xa12351957679f21fL).nextFloat(MinValue, MaxValue)
      )
      assertExactEquals(
        1.7215796e38f,
        make(0xa12351957679f21fL).nextFloat(MinValue / 3.0f, MaxValue)
      )

      assertExactEquals(
        5.684898e37f,
        make(0xe01389542264f955L).nextFloat(MinValue, MaxValue / 3.0f)
      )
      assertExactEquals(
        2.5541462e38f,
        make(0xe01389542264f955L).nextFloat(MinValue, MaxValue)
      )
      assertExactEquals(
        2.8370388e38f,
        make(0xe01389542264f955L).nextFloat(MinValue / 3.0f, MaxValue)
      )

      assertExactEquals(
        -3.0610379e38f,
        make(0x1348eac1e0b1d30dL).nextFloat(MinValue, MaxValue / 3.0f)
      )
      assertExactEquals(
        -2.890145e38f,
        make(0x1348eac1e0b1d30dL).nextFloat(MinValue, MaxValue)
      )
      assertExactEquals(
        -7.9248886e37f,
        make(0x1348eac1e0b1d30dL).nextFloat(MinValue / 3.0f, MaxValue)
      )
    }
    ...
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextFloat(-10.0f, -10.0f)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextFloat(-0.0f, 0.0f)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextFloat(5.0f, 4.0f)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextFloat(Float.MinValue, Float.MinValue)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextFloat(Float.NegativeInfinity, -1.0f)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextFloat(1.0f, Float.NegativeInfinity)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextFloat(Float.NaN, 0.0f)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextFloat(0.0f, Float.NaN)
    )
  }
  ...
  @Test def testNextDouble(): Unit = {
    assertExactEquals(
      0.8046754253236388,
      make(0xcdff356ba8f073c7L).nextDouble()
    )
    assertExactEquals(
      0.30401314320471184,
      make(0x4dd3ce2b9e4f98d3L).nextDouble()
    )
    assertExactEquals(
      0.7201104000768166,
      make(0xb85927b9d6e3249bL).nextDouble()
    )
    assertExactEquals(
      0.04668996021736527,
      make(0x0bf3df8c2f645e7dL).nextDouble()
    )
    assertExactEquals(
      0.5214750613951636,
      make(0x857f63be5f2f9ca0L).nextDouble()
    )
    assertExactEquals(
      0.6294451703929338,
      make(0xa12351957679f21fL).nextDouble()
    )
    assertExactEquals(
      0.8752981024175773,
      make(0xe01389542264f955L).nextDouble()
    )
    assertExactEquals(
      0.0753313754400502,
      make(0x1348eac1e0b1d30dL).nextDouble()
    )
    assertExactEquals(
      0.28671456694340003,
      make(0x496620384f075af6L).nextDouble()
    )
    assertExactEquals(
      0.7798930680610775,
      make(0xc7a71275b30dde50L).nextDouble()
    )
    assertExactEquals(
      0.9974991525015954,
      make(0xff5c1abdc835a88dL).nextDouble()
    )
    assertExactEquals(
      0.4876562354247512,
      make(0x7cd709fed6fc0e33L).nextDouble()
    )
    assertExactEquals(0.271466895425862, make(0x457edabdccfc99b3L).nextDouble())
    assertExactEquals(
      0.5253760623785295,
      make(0x867f0bae045cc0b5L).nextDouble()
    )
    assertExactEquals(
      0.8479163116811764,
      make(0xd9110b1c6a647a80L).nextDouble()
    )
    assertExactEquals(
      0.1561395746024723,
      make(0x27f8c35e876aa500L).nextDouble()
    )
    assertExactEquals(
      0.43756614605809874,
      make(0x700455bf2802ddacL).nextDouble()
    )
    assertExactEquals(
      0.026203216279220398,
      make(0x06b54104f821ddfeL).nextDouble()
    )
    assertExactEquals(
      0.7470020668222204,
      make(0xbf3b87070bbc6313L).nextDouble()
    )
  ...
  @Test def testNextDoubleWithBound(): Unit = {
    assertExactEquals(
      0.8046754253236388,
      make(0xcdff356ba8f073c7L).nextDouble(1.0)
    )
    assertExactEquals(
      0.15200657160235592,
      make(0x4dd3ce2b9e4f98d3L).nextDouble(0.5)
    )
    assertExactEquals(
      88902.51771898914,
      make(0xb85927b9d6e3249bL).nextDouble(123456.789)
    )
    assertExactEquals(
      7.059008395303237,
      make(0x0bf3df8c2f645e7dL).nextDouble(151.189)
    )
    assertExactEquals(
      0.0,
      make(0x857f63be5f2f9ca0L).nextDouble(Double.MinPositiveValue)
    )
    assertExactEquals(
      1.1315492615876175e308,
      make(0xa12351957679f21fL).nextDouble(Double.MaxValue)
    )
    ...
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextDouble(Double.MinValue)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextDouble(Double.PositiveInfinity)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextDouble(Double.NegativeInfinity)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextDouble(Double.NaN)
    )
  }
  ...
  @Test def testNextDoubleWithOriginAndBound(): Unit = {
    assertExactEquals(
      0.9023377126618194,
      make(0xcdff356ba8f073c7L).nextDouble(0.5, 1.0)
    )
    assertExactEquals(
      -10.63578970872461,
      make(0x4dd3ce2b9e4f98d3L).nextDouble(-15.5, 0.5)
    )
    assertExactEquals(
      745774.4195139175,
      make(0xb85927b9d6e3249bL).nextDouble(123456.789, 987654.321)
    )
    assertExactEquals(
      -561941.381818508,
      make(0x0bf3df8c2f645e7dL).nextDouble(-589456.0, -151.189)
    )
    assertExactEquals(
      123.456,
      make(0x857f63be5f2f9ca0L).nextDouble(123.456, 123.45600000000002)
    ) // 1 ulp of diff
    ...
    if (!executingInJVMOnLowerThanJDK(19)) {
      ...
      assertExactEquals(
        -2.8896078607882544e307,
        make(0xa12351957679f21fL).nextDouble(MinValue, MaxValue / 3.0)
      )
      assertExactEquals(
        4.654053883129194e307,
        make(0xa12351957679f21fL).nextDouble(MinValue, MaxValue)
      )
      assertExactEquals(
        9.095013038293849e307,
        make(0xa12351957679f21fL).nextDouble(MinValue / 3.0, MaxValue)
      )

      assertExactEquals(
        3.003300513698057e307,
        make(0xe01389542264f955L).nextDouble(MinValue, MaxValue / 3.0)
      )
      assertExactEquals(
        1.349341644485866e308,
        make(0xe01389542264f955L).nextDouble(MinValue, MaxValue)
      )
      assertExactEquals(
        1.4987921412780162e308,
        make(0xe01389542264f955L).nextDouble(MinValue / 3.0, MaxValue)
      )

      assertExactEquals(
        -1.6171295395712306e308,
        make(0x1348eac1e0b1d30dL).nextDouble(MinValue, MaxValue / 3.0)
      )
      assertExactEquals(
        -1.5268477419256879e308,
        make(0x1348eac1e0b1d30dL).nextDouble(MinValue, MaxValue)
      )
      assertExactEquals(
        -4.1866744966302007e307,
        make(0x1348eac1e0b1d30dL).nextDouble(MinValue / 3.0, MaxValue)
      )
    }
    ...
    assertExactEquals(
      ...
      make(0L)
        .nextDouble(Double.MinPositiveValue, 1024 * Double.MinPositiveValue)
    )

    assertThrows(
      classOf[IllegalArgumentException],
      make().nextDouble(-10.0, -10.0)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextDouble(-0.0, 0.0)
    )
    assertThrows(classOf[IllegalArgumentException], make().nextDouble(5.0, 4.0))
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextDouble(Double.MinValue, Double.MinValue)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextDouble(Double.NegativeInfinity, -1.0)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextDouble(1.0, Double.NegativeInfinity)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextDouble(Double.NaN, 0.0)
    )
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextDouble(0.0, Double.NaN)
    )
  }
  ...
  @Test def testNextIntWithBound(): Unit = {
    ...
    assertEquals(
      1047233791,
      make(0xff5c1abdc835a88dL, 0x7cd709fed6fc0e33L).nextInt(2000000000)
    )
  ...
  @Test def testNextIntWithOriginAndBound(): Unit = {
    ...
    assertEquals(
      529406464,
      make(0x4dd3ce2b9e4f98d3L).nextInt(-123456789, 987654321)
    )
    assertEquals(
      -453574692,
      make(0xb85927b9d6e3249bL).nextInt(-2000000000, -123456789)
    )
    ...
    assertEquals(
      -2147483647,
      make(0xa12351957679f21fL).nextInt(Int.MinValue, Int.MinValue + 3)
    )
    assertEquals(
      2147483645,
      make(0xe01389542264f955L).nextInt(Int.MaxValue - 3, Int.MaxValue)
    )
    ...
    assertEquals(
      47233791,
      make(0xff5c1abdc835a88dL, 0x7cd709fed6fc0e33L)
    ...
    assertEquals(
      1165941437,
      make(0x457edabdccfc99b3L).nextInt(-1000000000, 2000000000)
    )

    // bound - origin overflows and rejects one sample
    assertEquals(
      112541956,
      make(0x77fa600cd5741c70L, 0x06b54104f821ddfeL)
        .nextInt(-1000000000, 2000000000)
    )
    ...
    assertEquals(
      -999999058,
      make(0x867f0bae045cc0b5L).nextInt(-1000000000, -1000000000 + 1024)
    )
    assertEquals(
      420090567,
      make(0xd9110b1c6a647a80L).nextInt(-456789, -456789 + (1 << 30))
    )

    // The power of 2 that also overflows
    assertEquals(
      670157577,
      make(0x27f8c35e876aa500L).nextInt(-456789, -456789 + (1 << 31))
    )
    ...
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextInt(Int.MaxValue, Int.MinValue)
    )
  }
  ...
  @Test def testNextLongWithBound(): Unit = {
    ...
    assertEquals(
      6567945330301L,
      make(0x4dd3ce2b9e4f98d3L).nextLong(9876543219876L)
    )
    assertEquals(
      2641846127516815949L,
      make(0xb85927b9d6e3249bL).nextLong(4000000000000000000L)
    )
    assertEquals(6, make(0x0bf3df8c2f645e7dL).nextLong(10L))
    assertEquals(0, make(0x857f63be5f2f9ca0L).nextLong(1L))
    assertEquals(
      5805606983335475471L,
      make(0xa12351957679f21fL).nextLong(Long.MaxValue)
    )
    ...
    assertEquals(
      3459984693225774508L,
      make(0x700455bf2802ddacL).nextLong(1L << 62)
    )
  ...
  @Test def testNextLongWithOriginAndBound(): Unit = {
    ...
    assertEquals(
      2867080832779L,
      make(0x4dd3ce2b9e4f98d3L).nextLong(-1234567891234L, 9876543219876L)
    )
    assertEquals(
      -1358152637915292817L,
    ...
    assertEquals(
      ...
      make(0xa12351957679f21fL).nextLong(Long.MinValue, Long.MinValue + 3L)
    )
    assertEquals(
      9223372036854775806L,
      make(0xe01389542264f955L).nextLong(Long.MaxValue - 3L, Long.MaxValue)
    )
    assertEquals(
      694809301731568007L,
      make(0x1348eac1e0b1d30dL).nextLong(1, Long.MaxValue)
    )

    // Rejects one sample
    assertEquals(
      -1502165114585479399L,
      make(0xff5c1abdc835a88dL, 0x7cd709fed6fc0e33L)
        .nextLong(-2000000000000000000L, 2000000000000000000L)
    )

    // bound - origin overflows
    assertEquals(
      861277746941419133L,
      make(0x0bf3df8c2f645e7dL)
        .nextLong(-6000000000000000000L, 4000000000000000000L)
    )

    // bound - origin overflows and rejects one sample
    assertEquals(
      483364024610840062L,
      make(0x457edabdccfc99b3L, 0x06b54104f821ddfeL)
        .nextLong(-6000000000000000000L, 4000000000000000000L)
    )
    ...
    assertEquals(
      -999999819L,
      make(0x867f0bae045cc0b5L).nextLong(-1000000000L, -1000000000 + 1024L)
    )
    assertEquals(
      710771243L,
      make(0xd9110b1c6a647a80L).nextLong(-456789L, -456789L + (1L << 30))
    )
    assertEquals(
      2000214810766255360L,
      make(0x27f8c35e876aa500L)
        .nextLong(2000000000000000000L, 2000000000000000000L + (1L << 50))
    )
    assertEquals(
      3459983458657883274L,
      make(0x700455bf2802ddacL)
        .nextLong(-1234567891234L, -1234567891234L + (1L << 62))
    )

    // The power of 2 that also overflows
    assertEquals(
      4556382677778913777L,
      make(0xbf3b87070bbc6313L)
        .nextLong(-1234567891234L, -1234567891234L + (1L << 63))
    )
    ...
    assertThrows(
      classOf[IllegalArgumentException],
      make().nextLong(Long.MaxValue, Long.MinValue)
    )
  }
}
