...
class SizeofTest {
  ...
  @Test def testInnerStructCStruct2ByteCStruct2LongByte(): Unit = {
    assertTrue(sizeof[CStruct2[Byte, CStruct2[Long, Byte]]] == 24)
  }

  @Test def testInnerStructCStruct3ByteLongCStruct3IntIntByte(): Unit = {
    assertTrue(sizeof[CStruct3[Byte, Long, CStruct3[Int, Int, Byte]]] == 32)
  }
  ...
  @Test def testCArrayCStruct3ByteIntByteNat32(): Unit = {
    assertTrue(sizeof[CArray[CStruct3[Byte, Int, Byte], _32]] == 12 * 32)
  }
}
