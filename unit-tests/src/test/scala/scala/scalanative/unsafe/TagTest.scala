...
class TagTest {
  ...
  @Test def tagSize(): Unit = {
    assertTrue(tagof[Ptr[_]].size == 8)
    assertTrue(tagof[Object].size == 8)
    assertTrue(tagof[Array[_]].size == 8)
    assertTrue(tagof[Unit].size == 8)
    assertTrue(tagof[Boolean].size == 1)
    assertTrue(tagof[Char].size == 2)
    assertTrue(tagof[Byte].size == 1)
    assertTrue(tagof[UByte].size == 1)
    assertTrue(tagof[Short].size == 2)
    assertTrue(tagof[UShort].size == 2)
    assertTrue(tagof[Int].size == 4)
    assertTrue(tagof[UInt].size == 4)
    assertTrue(tagof[Long].size == 8)
    assertTrue(tagof[ULong].size == 8)
    assertTrue(tagof[Float].size == 4)
    assertTrue(tagof[Double].size == 8)
    assertTrue(tagof[CArray[Int, Nat._0]].size == 0)
    assertTrue(tagof[CArray[Int, Nat._3]].size == 4 * 3)
    assertTrue(tagof[CArray[Int, Nat._9]].size == 4 * 9)
    assertTrue(tagof[CStruct0].size == 0)
    assertTrue(tagof[CStruct1[Int]].size == 4)
    assertTrue(tagof[CStruct2[Byte, Int]].size == 8)
    assertTrue(tagof[CStruct3[Byte, Byte, Int]].size == 8)
  }
  ...
  @Test def tagAlignment(): Unit = {
    assertTrue(tagof[Ptr[_]].alignment == 8)
    assertTrue(tagof[Object].alignment == 8)
    assertTrue(tagof[Array[_]].alignment == 8)
    assertTrue(tagof[Unit].alignment == 8)
    assertTrue(tagof[Boolean].alignment == 1)
    assertTrue(tagof[Char].alignment == 2)
    assertTrue(tagof[Byte].alignment == 1)
    assertTrue(tagof[UByte].alignment == 1)
    assertTrue(tagof[Short].alignment == 2)
    assertTrue(tagof[UShort].alignment == 2)
    assertTrue(tagof[Int].alignment == 4)
    assertTrue(tagof[UInt].alignment == 4)
    assertTrue(tagof[Long].alignment == 8)
    assertTrue(tagof[ULong].alignment == 8)
    assertTrue(tagof[Float].alignment == 4)
    assertTrue(tagof[Double].alignment == 8)
    assertTrue(tagof[CArray[Int, Nat._0]].alignment == 4)
    assertTrue(tagof[CArray[Int, Nat._3]].alignment == 4)
    assertTrue(tagof[CArray[Int, Nat._9]].alignment == 4)
    assertTrue(tagof[CStruct0].alignment == 1)
    assertTrue(tagof[CStruct1[Int]].alignment == 4)
    assertTrue(tagof[CStruct2[Byte, Int]].alignment == 4)
    assertTrue(tagof[CStruct3[Byte, Byte, Int]].alignment == 4)
  }
  ...
  @Test def tagOffset(): Unit = {
    ...
    assertTrue(tagof[CArray[Int, Nat._0]].offset(42) == 4 * 42)
    ...
    assertTrue(tagof[CStruct2[Byte, CStruct2[Byte, Int]]].offset(0) == 0)
    assertTrue(tagof[CStruct2[Byte, CStruct2[Byte, Int]]].offset(1) == 4)
  }
