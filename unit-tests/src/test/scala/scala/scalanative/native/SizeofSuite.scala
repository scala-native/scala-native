...
object SizeofSuite extends tests.Suite {
  ...
  test("Ptr") {
    assert(sizeof[Ptr[_]] == Platform.cross3264(4, 8))
  }
  ...
  test("inner struct CStruct2[Byte, CStruct2[Long, Byte]]") {
    assert(
      sizeof[CStruct2[Byte, CStruct2[Long, Byte]]] == Platform.cross3264(16,
                                                                         24))
  }

  test("inner struct CStruct3[Byte, Long, CStruct3[Int, Int, Byte]]") {
    assert(
      sizeof[CStruct3[Byte, Long, CStruct3[Int, Int, Byte]]] == Platform
        .cross3264(24, 32))
  }
  ...
  test(
    ...
    assert(
      sizeof[CStruct3[
        Byte,
        Long,
        CStruct3[Int, Int, CStruct4[Byte, Int, Short, Byte]]]] == Platform
        .cross3264(32, 40))
  }
