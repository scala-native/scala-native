...
object FloatRyuSuite extends tests.Suite {
  ...
  test("Simple cases") {
    assertF2sEquals("0.0", 0f)
    assertF2sEquals("-0.0", java.lang.Float.intBitsToFloat(0x80000000))
    assertF2sEquals("1.0", 1.0f)
    assertF2sEquals("-1.0", -1.0f)
    assertF2sEquals("NaN", java.lang.Float.NaN)
    assertF2sEquals("Infinity", java.lang.Float.POSITIVE_INFINITY)
    assertF2sEquals("-Infinity", java.lang.Float.NEGATIVE_INFINITY)
  }
