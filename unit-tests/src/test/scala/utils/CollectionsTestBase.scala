...
trait CollectionsTestBase {
  ...
  def testSortedSetUnmodifiability[E](set: ju.SortedSet[E],
                                      elem: E,
  ...
  def testListUnmodifiability[E](list: ju.List[E],
                                 elem: E,
                                 recursive: Boolean = false): Unit = {
  ...
  def testMapUnmodifiability[K, V](map: ju.Map[K, V],
                                   key: K,
                                   value: V): Unit = {
  ...
  def testSortedMapUnmodifiability[K, V](map: ju.SortedMap[K, V],
                                         key: K,
                                         value: V,
                                         recursive: Boolean = false): Unit = {
