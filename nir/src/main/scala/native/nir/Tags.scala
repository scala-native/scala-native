...
object Tags {
  ...
  final val ObjAllocOp         = 1 + ConvOp
  final val ObjFieldElemOp     = 1 + ObjAllocOp
  final val ObjMethodElemOp    = 1 + ObjFieldElemOp
  final val ObjAsOp            = 1 + ObjMethodElemOp
  final val ObjIsOp            = 1 + ObjAsOp
