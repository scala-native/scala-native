...
object Tags {
  ...
  final val ObjEqualsOp        = 1 + ObjMethodElemOp
  final val ObjHashCodeOp      = 1 + ObjEqualsOp
  final val ObjToStringOp      = 1 + ObjHashCodeOp
  final val ObjGetClassOp      = 1 + ObjToStringOp
  final val ObjAsOp            = 1 + ObjGetClassOp
  ...
  final val PrimBoxOp          = 1 + ArrElemOp
  final val PrimUnboxOp        = 1 + PrimBoxOp
  final val PrimParseOp        = 1 + PrimUnboxOp
  final val PrimHashCodeOp     = 1 + PrimParseOp
  final val PrimToStringOp     = 1 + PrimHashCodeOp
  final val MonitorEnterOp     = 1 + PrimToStringOp
  final val MonitorExitOp      = 1 + MonitorEnterOp
  final val MonitorNotifyOp    = 1 + MonitorExitOp
  final val MonitorNotifyAllOp = 1 + MonitorNotifyOp
  final val MonitorWaitOp      = 1 + MonitorNotifyAllOp
  final val StringConcatOp     = 1 + MonitorWaitOp

  final val NoneType           = 1 + StringConcatOp
