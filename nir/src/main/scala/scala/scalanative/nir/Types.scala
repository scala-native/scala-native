...
object Type {
  ...
  sealed abstract class Width { val v: Int }
  object Width {
  ...
  case object W1  extends Width { val v: Int = 1  }
  case object W8  extends Width { val v: Int = 8  }
  case object W16 extends Width { val v: Int = 16 }
  case object W32 extends Width { val v: Int = 32 }
  case object W64 extends Width { val v: Int = 64 }
  ...
  implicit class ConvFromOps[T <: Width, S <: Width](val x: ConvFrom.Aux[T])
    ...
    def compare(y: ConvFrom.Aux[S]) = x.width.v.compare(y.width.v)
  }
